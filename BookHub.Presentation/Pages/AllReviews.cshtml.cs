...
namespace BookHub.Presentation.Pages
{
    public class AllReviewsModel : PageModel
    {
        ...
        public List<BookReview> AllReviews { get; set; } = new List<BookReview>();
        ...
        private void LoadReviews()
        {
            try
            {
                ...
                var allReviews = new List<BookReview>();
                ...
                foreach (var book in books)
                {
                    ...
                    {
                        // Ensure book information is populated
                ...
                if (ShowMyReviews)
                {
                    ...
                    {
                        // If not logged in, show no reviews
                        filteredReviews = Enumerable.Empty<BookReview>();
                    }
                }
                ...
                filteredReviews = SortBy switch
                {
                    ...
                    _ => filteredReviews.OrderByDescending(r => r.ReviewDate) // recent (default)
                };
            ...
            {
                AllReviews = new List<BookReview>();
                TotalReviews = 0;
                TotalPages = 0;
            }
        }
