...
namespace BookHub.BLL
{
    public class BookClubBLL
    {
        ...
        // Create a new book club with validation
        ...
        // Get book clubs user belongs to
        ...
        // Join a book club with validation
        ...
        // Leave a book club with validation
        public bool LeaveBookClub(int bookClubId, int userId)
        {
            try
            {
                ...
                // Don't allow creator to leave their own book club
                var bookClub = _bookClubDAL.GetBookClubById(bookClubId);
        ...
        // Check if book club is at capacity
        ...
        // Search book clubs with validation
        public List<BookClub> SearchBookClubs(string? searchTerm = null, string? genre = null)
        {
            try
            {
                ...
                // Combine search term and genre if needed
        ...
        // Get user's membership status for a book club
